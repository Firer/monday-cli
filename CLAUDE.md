...
- R-NEW-72 (post-fix-up cross-doc grep) — 5-instance ratified
  + a noun-stem grep-pattern refinement lesson from rounds
  3-4 (M35 post-mortem §12 Contract drift findings #2).
